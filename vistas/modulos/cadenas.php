...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Administrar cadenas</li>
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn btn-primary" data-toggle="modal" data-target="#modalAgregarCadena">
...
<!--           <th>Teléfono</th>-->
        ...
        <?php
          ...
          $cadenas = Controladorcadenas::ctrMostrarcadenas($item, $valor);
            ...
            echo '<tr>
                    ...
                    <td>
                      ...
                      <div class="btn-group">
                        ...
                        <button class="btn btn-warning btnEditarCadena" data-toggle="modal" data-target="#modalEditarCadena" idCadena="'.$value["id"].'"><i class="fa fa-pencil"></i></button>';

                      if($_SESSION["perfil"] == "Administrador"){

                          echo '<button class="btn btn-danger btnEliminarCadena" idCadena="'.$value["id"].'"><i class="fa fa-times"></i></button>';
...
<div id="modalAgregarCadena" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
        ...
        <div class="modal-header" style="background:#3c8dbc; color:white">
          ...
          <h4 class="modal-title">Agregar cadena</h4>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary">Guardar cadena</button>
      ...
      <?php
        ...
        $crearcadena = new Controladorcadenas();
        $crearcadena -> ctrCrearcadena();
...
<div id="modalEditarCadena" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
        ...
        <div class="modal-header" style="background:#3c8dbc; color:white">
          ...
          <h4 class="modal-title">Editar Cadena</h4>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" id="editarFechaRegistro" name="editarFechaRegistro" value="<?= date('Y-m-d') ?>" placeholder="Fecha de registro"  readonly required>
      ...
      <?php
        ...
        $editarCadena = new ControladorCadenas();
        $editarCadena -> ctrEditarCadena();
...
<?php
  ...
  $eliminarCadena = new Controladorcadenas();
  $eliminarCadena -> ctrEliminarcadena();
